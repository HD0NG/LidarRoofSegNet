module.exports = {
  apps: [
    {
      name: '<ValThresholdSweep_LiDARML_20260612>',
      script: 'scripts/run_val_threshold_sweep.sh',
      interpreter: '/bin/bash', // LightGBM threshold sweep on the VAL split for operating-point selection
